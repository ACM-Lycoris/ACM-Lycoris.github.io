...
date: 2026-04-22T20:38:10+08:00
draft: false
tags:
  - c++
  - 算法
...
categories:
  - GPLT天梯赛
  - 2026
description: 来自2026.4.18日全国团体程序设计天梯赛2026总决赛
---
...
.gplt-desc {
    ...
    padding: 0.9rem 1rem;
    border-left: 4px solid #6a3b9a;
    background: linear-gradient(180deg, #faf7fc 0%, #f5eff9 100%);
    border-radius: 8px;
    line-height: 1.75;
}
...
.gplt-mini-toc {
    ...
    border: 1px solid #d2c4de;
    border-radius: 8px;
    background: #fbf9fd;
}

.gplt-toc summary,
.gplt-mini-toc summary {
    cursor: pointer;
    font-weight: 600;
}
...
<div id="post-toc"></div>
<details class="gplt-toc">
    <summary>📚 题目目录（点击展开 / 收起）</summary>
...
## <span id="l1-1"></span>L1-1 一行代码

**分数**：5

<details class="gplt-mini-toc">
    <summary>🔖 本题小目录</summary>

- [题目描述](#l1-1-desc)
- [输入格式](#l1-1-input-format)
- [输出格式](#l1-1-output-format)
- [输入样例](#l1-1-input-sample)
- [输出样例](#l1-1-output-sample)
- [限制](#l1-1-limits)
- [思路](#l1-1-solution)
- [代码](#l1-1-code)
- [返回总目录](#post-toc)
...
### <span id="l1-1-input-format"></span>输入格式

本题没有输入。

### <span id="l1-1-output-format"></span>输出格式

在一行中输出 `Building the Future, One Line of Code at a Time.`

### <span id="l1-1-input-sample"></span>输入样例

```text
无
```

### <span id="l1-1-output-sample"></span>输出样例

```text
Building the Future, One Line of Code at a Time.
```

### <span id="l1-1-limits"></span>限制
...
### <span id="l1-1-solution"></span>思路

本题没有任何难点，直接输出指定字符串即可。

### <span id="l1-1-code"></span>代码 (Python)
...
- [题目描述](#l1-2-desc)
- [输入格式](#l1-2-input-format)
- [输出格式](#l1-2-output-format)
- [输入样例](#l1-2-input-sample)
- [输出样例](#l1-2-output-sample)
- [限制](#l1-2-limits)
- [思路](#l1-2-solution)
- [代码](#l1-2-code)
- [返回总目录](#post-toc)
...
### <span id="l1-2-input-format"></span>输入格式

输入第一行给出一个正整数 n（≤10），为题面中所述老师提出的比赛年数。

### <span id="l1-2-output-format"></span>输出格式

在一行中输出学生需要做完的题目总数

### <span id="l1-2-input-sample"></span>输入样例

```text
2
```

### <span id="l1-2-output-sample"></span>输出样例

```text
30
```

### <span id="l1-2-limits"></span>限制
...
### <span id="l1-2-solution"></span>思路

直接输出n*15

### <span id="l1-2-code"></span>代码(c++)
...
- [题目描述](#l1-3-desc)
- [输入格式](#l1-3-input-format)
- [输出格式](#l1-3-output-format)
- [输入样例1](#l1-3-input-sample-1)
- [输出样例1](#l1-3-output-sample-1)
- [输入样例2](#l1-3-input-sample-2)
- [输出样例2](#l1-3-output-sample-2)
- [输入样例3](#l1-3-input-sample-3)
- [输出样例3](#l1-3-output-sample-3)
- [限制](#l1-3-limits)
- [思路](#l1-3-solution)
- [代码](#l1-3-code)
- [返回总目录](#post-toc)
...
### <span id="l1-3-input-format"></span>输入格式

输入在一行给出 2 个不超过 5000 的正整数 A 和 B，对应的标语为“蹲厕所时突然想到，A 年出生的孩子，能活到 B 年”。

### <span id="l1-3-output-format"></span>输出格式
...
### <span id="l1-3-input-sample-1"></span>输入样例1

```text
2026 3001
```

### <span id="l1-3-output-sample-1"></span>输出样例1
...
### <span id="l1-3-input-sample-2"></span>输入样例2

```text
3001 2026
```

### <span id="l1-3-output-sample-2"></span>输出样例2
...
### <span id="l1-3-input-sample-3"></span>输入样例3

```text
2025 2275
```

### <span id="l1-3-output-sample-3"></span>输出样例3
...
- [题目描述](#l1-4-desc)
- [输入格式](#l1-4-input-format)
- [输出格式](#l1-4-output-format)
- [输入样例](#l1-4-input-sample)
- [输出样例](#l1-4-output-sample)
- [限制](#l1-4-limits)
- [思路](#l1-4-solution)
- [代码](#l1-4-code)
- [返回总目录](#post-toc)
...
### <span id="l1-4-output-sample"></span>输出样例

```text
3
```

### <span id="l1-4-limits"></span>限制
...
### <span id="l1-4-solution"></span>思路

定义一个计数器，小于1700就+1

### <span id="l1-4-code"></span>代码(c++)
...
## <span id="l1-5"></span>L1-5 做什么都被骂怎么办
...
- [题目描述](#l1-5-desc)
- [输入格式](#l1-5-input-format)
- [输出格式](#l1-5-output-format)
- [输入样例1](#l1-5-input-sample-1)
- [输出样例1](#l1-5-output-sample-1)
- [输入样例2](#l1-5-input-sample-2)
- [输出样例2](#l1-5-output-sample-2)
- [限制](#l1-5-limits)
- [思路](#l1-5-solution)
- [代码](#l1-5-code)
- [返回总目录](#post-toc)
...
### <span id="l1-5-input-format"></span>输入格式
...
### <span id="l1-5-output-format"></span>输出格式

在一行中按升序输出那些什么都可以做（即做什么都被骂）的人的编号。数字间以 1 个空格分隔，行首尾不得有多余空格。
如果不存在这样的人，输出 NONE。

### <span id="l1-5-input-sample-1"></span>输入样例1
...
### <span id="l1-5-output-sample-1"></span>输出样例1

```text
2 5555 23333
```

### <span id="l1-5-input-sample-2"></span>输入样例2
...
### <span id="l1-5-output-sample-2"></span>输出样例2

```text
NONE
```

### <span id="l1-5-limits"></span>限制
...
## <span id="l1-6"></span>L1-6 钓鱼佬专用挪车电话
...
- [题目描述](#l1-6-desc)
- [输入格式](#l1-6-input-format)
- [输出格式](#l1-6-output-format)
- [输入样例](#l1-6-input-sample)
- [输出样例](#l1-6-output-sample)
- [限制](#l1-6-limits)
- [思路](#l1-6-solution)
- [代码](#l1-6-code)
- [返回总目录](#post-toc)
...
### <span id="l1-6-input-format"></span>输入格式

输入分 11 行，每行对应 11 位手机号码的一位数字，给出由 m 组成的字符串，以回车结束。每个 m 代表鱼漂上的一目，一行中有多少 m 就表示这一位数字是多少，空行代表 0。题目保证每行都不超过 9 个 m。

### <span id="l1-6-output-format"></span>输出格式

一行输出钓鱼佬的手机号

### <span id="l1-6-input-sample"></span>输入样例
...
### <span id="l1-6-output-sample"></span>输出样例

```text
12831218082
```

### <span id="l1-6-limits"></span>限制
...
- [题目描述](#l1-7-desc)
- [输入格式](#l1-7-input-format)
- [输出格式](#l1-7-output-format)
- [输入样例1](#l1-7-input-sample-1)
- [输出样例1](#l1-7-output-sample-1)
- [输入样例2](#l1-7-input-sample-2)
- [输出样例2](#l1-7-output-sample-2)
- [限制](#l1-7-limits)
- [思路](#l1-7-solution)
- [代码](#l1-7-code)
- [返回总目录](#post-toc)
...
### <span id="l1-7-output-sample-1"></span>输出样例1
...
### <span id="l1-7-input-sample-2"></span>输入样例2
...
### <span id="l1-7-output-sample-2"></span>输出样例2
...
### <span id="l1-7-solution"></span>思路

题目很明白了

### <span id="l1-7-code"></span>代码(c++)
...
## <span id="l1-8"></span>L1-8 智慧文本编辑器
...
- [题目描述](#l1-8-desc)
- [输入格式](#l1-8-input-format)
- [输出格式](#l1-8-output-format)
- [输入样例](#l1-8-input-sample)
- [输出样例](#l1-8-output-sample)
- [数据约定](#l1-8-data)
- [限制](#l1-8-limits)
- [思路](#l1-8-solution)
- [代码](#l1-8-code)
...
### <span id="l1-8-input-format"></span>输入格式
...
### <span id="l1-8-output-format"></span>输出格式
...
### <span id="l1-8-input-sample"></span>输入样例
...
### <span id="l1-8-output-sample"></span>输出样例
...
### <span id="l1-8-data"></span>数据约定

题目中设置三个单一操作的数据，对应三种不同的操作，三个数据加起来分配不超过 75% 的分数。

### <span id="l1-8-limits"></span>限制
...
### <span id="l1-8-solution"></span>思路

大字符串，会用insert,find,reverse就是水题

### <span id="l1-8-code"></span>代码(c++)
...
- [题目描述](#l2-1-desc)
- [输入格式](#l2-1-input-format)
- [输出格式](#l2-1-output-format)
- [输入样例](#l2-1-input-sample)
- [输出样例](#l2-1-output-sample)
- [限制](#l2-1-limits)
- [思路](#l2-1-solution)
- [代码](#l2-1-code)
- [返回总目录](#post-toc)
...
### <span id="l2-1-input-format"></span>输入格式
...
### <span id="l2-1-output-format"></span>输出格式

按照姥姥批改作业的顺序，在一行中输出每个作业本的编号。数字间以 1 个空格分隔，行首尾不得有多余空格。

### <span id="l2-1-input-sample"></span>输入样例
...
### <span id="l2-1-output-sample"></span>输出样例

```text
3 5 7 10 9 4 2 1 8 6
```

### <span id="l2-1-limits"></span>限制
...
- [题目描述](#l2-2-desc)
- [输入格式](#l2-2-input-format)
- [输出格式](#l2-2-output-format)
- [输入样例](#l2-2-input-sample)
- [输出样例](#l2-2-output-sample)
- [限制](#l2-2-limits)
- [思路](#l2-2-solution)
- [代码](#l2-2-code)
- [返回总目录](#post-toc)
...
### <span id="l2-2-input-format"></span>输入格式
...
### <span id="l2-2-output-format"></span>输出格式
...
### <span id="l2-2-input-sample"></span>输入样例
...
### <span id="l2-2-output-sample"></span>输出样例
...
- [题目描述](#l2-3-desc)
- [输入格式](#l2-3-input-format)
- [输出格式](#l2-3-output-format)
- [输入样例](#l2-3-input-sample)
- [输出样例](#l2-3-output-sample)
- [限制](#l2-3-limits)
- [思路](#l2-3-solution)
- [代码](#l2-3-code)
- [返回总目录](#post-toc)
...
### <span id="l2-3-input-format"></span>输入格式
...
### <span id="l2-3-output-sample"></span>输出样例
...
## <span id="l2-4"></span>L2-4 大语言模型的推理
...
- [题目描述](#l2-4-desc)
- [输入格式](#l2-4-input-format)
- [输出格式](#l2-4-output-format)
- [输入样例](#l2-4-input-sample)
- [输出样例](#l2-4-output-sample)
- [限制](#l2-4-limits)
- [思路](#l2-4-solution)
- [代码](#l2-4-code)
- [返回总目录](#post-toc)
...
### <span id="l2-4-desc"></span>题目描述

<div class="gplt-desc">
神经网络模型的超参数是训练前需预先设定的参数，直接影响模型性能。在机器学习过程中需要对超参数进行优化，给学习器选择一组最优超参数，以提高学习的性能和效果。假设我们记录了一系列不同参数组合在验证集上的性能得分（如准确率），本题就请你找出性能得分最高的参数组合。更进一步，对于工程师提出的任一个目标性能得分 x，你也要从所有性能得分大于x 的参数组合中，找到那个得分最小的组合。
</div>

### <span id="l2-4-input-format"></span>输入格式

输入第一行给出正整数 n（1<n≤10^5），为所有在验证集上跑过的参数组合的总量。于是我们将所有参数组合从 1 到 n 进行编号。第二行给出 n 个区间 [0,10^8] 内的整数，第 i 个数字表示编号为 i 的参数组合的性能得分。随后一行给出正整数 m（≤n/2），为工程师查询次数。接下来 m 行，每行给出一个查询的目标性能得分 x，同样在区间 [0,10^8] 内。

### <span id="l2-4-output-format"></span>输出格式

首先第一行按升序列出所有性能得分最高的参数组合的编号。同行数字间以 1 个空格分隔，行首尾不得有多余空格。
随后对每一次查询 x，我们需要从所有性能得分大于 x 的参数组合中，找到并输出那个得分最小的组合编号。如果这样的参数组合不唯一，则输出编号最小的解。如果这样的参数组合不存在，则输出 0。

### <span id="l2-4-input-sample"></span>输入样例
...
### <span id="l2-4-output-sample"></span>输出样例
...
## <span id="l3-1"></span>L3-1 门诊预约排队系统
...
- [题目描述](#l3-1-desc)
- [输入格式](#l3-1-input-format)
- [输出格式](#l3-1-output-format)
- [输入样例](#l3-1-input-sample)
- [输出样例](#l3-1-output-sample)
- [限制](#l3-1-limits)
- [思路](#l3-1-solution)
- [代码](#l3-1-code)
- [返回总目录](#post-toc)
...
### <span id="l3-1-input-format"></span>输入格式
...
### <span id="l3-1-output-format"></span>输出格式

输出 *n* 行，按照实际就诊时间段的递增顺序，每行输出一位患者的实际就诊时间段和 ID，其间以 1 个空格分隔，行首尾不得有多余空格。

### <span id="l3-1-input-sample"></span>输入样例
...
### <span id="l3-1-output-sample"></span>输出样例
...
L3-2涉及图论Hopcroft-Karp算法，单独写一篇博客链接稍后挂在这里
L3-3作者研究不出来了，求饶（）
